...
{{ link(url="zhiwen.xfyun.cn", icon="zhiwen.ico", name="讯飞智文",con="免费ai生成ppt，科大讯飞" ) }}
</div>
...
{{ link(url="datong.info", icon="datong.ico", name="大同搜索",con="ai搜索引擎" ) }}
...
{{ link(url="cook.aiursoft.cn", icon="aiursoft.png", name="程序员菜谱",con="精准到克的菜谱" ) }}
